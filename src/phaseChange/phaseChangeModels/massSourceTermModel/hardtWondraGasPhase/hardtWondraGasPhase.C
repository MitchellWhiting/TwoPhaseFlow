...
Foam::hardtWondraGasPhase::hardtWondraGasPhase
(
...
Foam::hardtWondraGasPhase::massSource( volScalarField& rhoSource)
{
...
Foam::tmp<Foam::volScalarField>
Foam::hardtWondraGasPhase::alphaSource( volScalarField& rhoSource)
{
